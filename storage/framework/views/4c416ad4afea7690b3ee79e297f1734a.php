...
<head>
  ...
  <title>Desa Dawuan - Sejarah Desa</title>
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          ...
          <div class="member-img">
              <img src="assets/img/Dawuan.jpg" alt="" class="img-fluid" >
          </div>
          <br>
          <p>Sejarah Desa Dawuan di Majalengka berawal dari penemuan kawasan oleh dua pemuda Cirebon, dengan nama berasal dari kata "dawu" (membendung), karena lokasinya membendung anak sungai Cimanuk, lalu berkembang menjadi desa yang kemudian dimekarkan menjadi Dawuan Barat dan Timur, mencerminkan dinamika perkembangan wilayah dan identitas lokal di Majalengka. Desa Dawuan merupakan desa lama yang berkembang dari permukiman agraris, Perkembangan desa dipengaruhi oleh sistem pertanian sawah, jalur penghubung antarwilayah Kadipaten, dan dalam beberapa tahun terakhir, dampak pembangunan infrastruktur regional (akses jalan, ekonomi).</p>   
        </div>
      </div>
    </section>
  </main><!-- End #main -->
...
</html><?php /**PATH E:\BERKAS KULIAH\PW PRAKTEK\Kelompok 8 Web Desa\resources\views/profil/sejarah.blade.php ENDPATH**/ ?>