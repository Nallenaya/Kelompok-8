<?php $__env->startSection('title','Data Berita Desa Dawuan'); ?>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/image/<?php echo e($news->image); ?>" alt="" class="img-fluid" width="90">
                    </td>
                    <td>
                        <a href="<?php echo e(route('news.edit', $news->id)); ?>" class="btn btn-warning">Edit</a>
                        <br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Kelompok 8 Web Desa\resources\views/news/index.blade.php ENDPATH**/ ?>