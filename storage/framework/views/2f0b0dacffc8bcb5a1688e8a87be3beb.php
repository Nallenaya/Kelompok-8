...
<head>
  ...
  <title>Desa Dawuan - Aset Desa</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="section-title">
      <h2>ASET DESA DAWUAN</h2>
      <br>
      <p>
      Aset Desa Dawuan, Majalengka, mencakup berbagai jenis kekayaan desa seperti tanah kas desa, pasar, bangunan desa, aset pertanian (sawah), kendaraan operasional (sepeda motor), hingga properti lainnya (rumah tinggal, dll.) yang dikelola sesuai Peraturan Desa (Perdes) untuk kesejahteraan warga, dengan rincian spesifik bisa ditemukan dalam dokumen pengelolaan aset desa atau laporan kecamatan
      </p>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Kelompok 8 Web Desa\resources\views/profil/aset.blade.php ENDPATH**/ ?>