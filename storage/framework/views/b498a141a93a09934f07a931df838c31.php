...
<body>
  ...
  <div class="container">
    <div class="section-title">
      <h2>POTENSI DESA DAWUHAN</h2>
    </div>

    <div class="row">
        <div class="col-12">
            <p style="text-align: justify; font-size: 16px;">
                Potensi utama Desa Dawuan, Majalengka, terletak pada pertanian padi yang didukung irigasi memadai, menjadikannya sumber ketahanan pangan lokal dan pendapatan petani, serta memiliki potensi perkebunan dan perternakan yang sedang dikembangkan menjadi pasar induk sayur dan ternak, menjadikannya pusat ekonomi lokal di Kecamatan Dawuan
            </p>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Kelompok 8 Web Desa\resources\views/profil/potensi.blade.php ENDPATH**/ ?>