  ...
  <section id="featured-services" class="featured-services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Event Terbaru Desa Dawuan</h2>
        </div>

        <div class="row">

    <div class="col-md-4 d-flex align-items-stretch">
        <div style="padding: 30px; background: #fff; box-shadow: 0 0 15px rgba(0,0,0,0.1); border-radius: 10px; width: 100%;">
            <p style="text-align: justify;">
                <strong>Topik Pertama</strong><br>
                Kegiatan "Guar Bumi" (Sedekah Bumi): Tradisi luhur masyarakat Majalengka ini masih lestari dan dilaksanakan di berbagai desa di Kecamatan Dawuan untuk menyambut musim tanam, seperti yang dilakukan di Desa Balida dan Desa Baturuyuk pada Oktober 2025.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-4 d-flex align-items-stretch mt-4 mt-md-0">
        <div style="padding: 30px; background: #fff; box-shadow: 0 0 15px rgba(0,0,0,0.1); border-radius: 10px; width: 100%;">
            <p style="text-align: justify;">
                <strong>Topik Kedua</strong><br>
                Gerakan Pangan Murah dalam "Sapa Bunda SAE": Program inovatif dari TP PKK Kabupaten Majalengka ini diluncurkan di Desa Gandu, Kecamatan Dawuan, pada Desember 2025, bertujuan untuk memberikan kemudahan akses pangan bagi masyarakat.
        </div>
    </div>
    ...
    <div class="col-md-4 d-flex align-items-stretch mt-4 mt-md-0">
        <div style="padding: 30px; background: #fff; box-shadow: 0 0 15px rgba(0,0,0,0.1); border-radius: 10px; width: 100%;">
            <p style="text-align: justify;">
                <strong>Topik Ketiga</strong><br>
                "Geber" (Gerakan Bersih-bersih): Kegiatan gotong royong rutin untuk menjaga lingkungan yang juga melibatkan aparatur desa dan masyarakat di berbagai wilayah di Majalengka, termasuk di area kecamatan Dawuan pada November 2025.
            </p>
        </div>
    </div>
  </section>
...
</html><?php /**PATH C:\xampp\htdocs\Kelompok 8 Web Desa\resources\views/home/event.blade.php ENDPATH**/ ?>