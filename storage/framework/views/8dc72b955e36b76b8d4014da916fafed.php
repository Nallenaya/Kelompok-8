<?php $__env->startSection('title','Data Event Dawuan'); ?>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/image/<?php echo e($event->image); ?>" alt="" class="img-fluid" width="90">
                    </td>
                    <td>
                        <a href="<?php echo e(route('event.edit', $event->id)); ?>" class="btn btn-warning">Edit</a>
                        <br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kelompok 8 Web Desa\resources\views/event/index.blade.php ENDPATH**/ ?>