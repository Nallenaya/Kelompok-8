...
<head>
  ...
  <title>Desa Dawuan | AKTA KEMATIAN</title>
...
<body>
  ...
  <div class="section-title" mt-4>
    <h2>SYARAT PEMBUATAN AKTA KEMATIAN</h2>
  </div>
  <div class="container">
    <h6>DESKRIPSI</h6>
    <p>Akta kematian diterbitkan untuk penduduk yang telah wafat. Penduduk tersebut akan dihapuskan dari Kartu Keluarga dan Nomor Induk Kependudukan, untuk mencegah data kependudukannya disalahgunakan oleh pihak-pihak yang tidak bertanggungjawab. Selain akta kematian, kartu keluarga yang baru juga akan diterbitkan sebagai hasil dari pelaporan kita. Akta kematian bermanfaat bagi kita untuk mengurus penetapan ahli waris, mengurus pensiunan janda/duda, mengurus klaim asuransi, dan juga persyaratan untuk melaksanakan perkawinan kembali.</p>

    <br>
    <h6>SYARAT PEMBUATAN AKTA KEMATIAN</h6>
    <p>Syarat-syarat yang harus dipenuhi dalam Permohonan Pembuatan Akta Kelahiran Baru:</p>
    <ol>
      <li>Surat Pengantar RT/RW</li>
      <li>Surat Keterangan Kematian dari Rumah Sakit (Visum)</li>
      <li>Fotocopy Kartu Keluarga / Kartu Tanda Penduduk yang dilegalisir Lurah</li>
      <li>Surat Keterangan Tamu/KIPEM bagi yang bukan Penduduk Propinsi terkait</li>
      <li>Surat Keterangan Pendaftaran Penduduk Tetap (SKPPT) bagi Penduduk WNA</li>
      <li>Surat Keterangan Pendaftaran Penduduk Sementara (SKPPS) bagi Orang Asing Penduduk Sementara</li>
    </ol>
  </div>
  <!-- ======= Footer ======= -->
  <footer id="footer">
...
</html><?php /**PATH C:\xampp\htdocs\Kelompok 8 Web Desa\resources\views/home/aktekematian.blade.php ENDPATH**/ ?>